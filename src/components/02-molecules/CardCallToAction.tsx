...
export const CardCallToAction = () => {
	...
	return (
		<div className="relative flex h-[302px] w-full flex-col items-center md:h-[470px]">
			...
			<div className="duration-3000 absolute right-[20%] top-[37px] flex h-[25px] w-[25px] animate-spin md:right-[15%] md:h-[40px] md:w-[40px]">
				{isMobile ? (
			...
			<div className="duration-3000 absolute bottom-[132px] left-[20%] flex h-[25px] w-[25px] animate-spin md:left-[15%] md:h-[40px] md:w-[40px]">
				{isMobile ? (
